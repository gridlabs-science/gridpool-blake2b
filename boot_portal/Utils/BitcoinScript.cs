...
public static class BitcoinScript
{
    ...
    public static byte[] AddressToScriptPubKey(string address, string? network)
    {
            ...
            normalized.StartsWith("bcrt1", StringComparison.OrdinalIgnoreCase))
        {
            ...
            string expectedHrp = normalizedNetwork switch
            {
                Testnet4 => "tb",
                Regtest => "bcrt",
                _ => "bc"
        ...
        return payload[0] switch
        {
            ...
            0x6f when normalizedNetwork is Testnet4 or Regtest => BuildP2PkhScript(payload),
            0xc4 when normalizedNetwork is Testnet4 or Regtest => BuildP2ShScript(payload),
    ...
    public static string ScriptToAddress(byte[] script, string? network)
    {
            ...
            script[24] == 0xAC)
        {
            ...
            payload[0] = normalizedNetwork is Testnet4 or Regtest ? (byte)0x6f : (byte)0x00;
        ...
        {
            byte[] payload = new byte[21];
            payload[0] = normalizedNetwork is Testnet4 or Regtest ? (byte)0xc4 : (byte)0x05;
    ...
    private static string GetBech32Hrp(string normalizedNetwork)
    {
