...
| Antminer S19 XP | `Antminer S19 XP\|LUXminer 2025.7.10.152155-6e13fb74\|BHB56801\|Unknown\|Unknown\|blockware` | DATUM forced full-coinbase test endpoint | fingerprinted `ANTMAIN2` class 2; forced `YUGE` class 4 with unsafe override | fails | GridPool testnet full-coinbase endpoint, 2026-07-08/09 | Safe mode was intentionally disconnected by DATUM because class 2 is smaller than forced class 4. With password override `UNSAFE_FULL_COINBASE`, the miner stayed subscribed/authorized and DATUM generated 300-output jobs (`Coinbaser v2 size 10201`), but LuxOS reported `Accepted: 0`, `Rejected: 0`, `Best Share: 0`, `Work Difficulty: 0`, while other pools continued hashing. Failure mode appears to be silent idle/no shares, not a firmware hard lock. |
| LuxOS | other versions/models | DATUM / Hydrapool | unknown | untested | community testing needed | One S19 XP/LUXminer result failed full 300-output DATUM testing; do not generalize to all LuxOS versions without testing. |
