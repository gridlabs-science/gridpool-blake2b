...
- `gridlabs-science/datum-gateway-blake2b-gridpool`: GitHub fork of the most-used Blake2b DATUM implementation, initially pinned to `justinfilip/datum_gateway@e894b8a`.
