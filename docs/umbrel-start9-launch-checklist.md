...
- [ ] Promote the RT-2026-041/042 security release only after the follow-up
  candidate closes RT-2026-076 and independently confirms regtest paid-once,
  notification-first, and complete-proof sibling convergence. The 2026-08-26
  retest already confirmed that declared-target candidates cannot rotate payout
  state and proofless bundles cannot alter winners or paid lineage. See
